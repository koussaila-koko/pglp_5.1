 ...
 * Implémentes Composant et IterableComposant.
 * @author koussaila
 */
public class Groupe implements Composite, Serializable {
	...
	public void add(final Composite c) {
	 ...
	 /**
     *fontion print
     * Retourne les compisite du groupe.
     */
	public void print() {
     ...
     */
	 public String getNom() {
	   ...
	   /**
	     * Retorune le nombre de composants
	    ...
	    /**
	     * methode toString c'est a partir de groupe on
	     * Retourne une chaine de caractère représentant ce groupe.

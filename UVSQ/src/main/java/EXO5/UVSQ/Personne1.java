...
/**
 * la classe personnel.
 * Possede un nom et prenom, une fonction,
 * une date de naissance et une liste de
 * Numero_telephone.
 * @author koussaila
 */
	 ...
	 */
     ...
     public static class Builder {
         ...
         private ArrayList<Numero_telephone> num_telephone;
           /**
          * Constructeur.
          * Creation d'un builder pour Personnel.
          * @param i Identifiant
         ...
         /**
          * la methode fonction
          * pour changer la fonction de personnel.
         ...
         /**
          * la methode Date_naissance
          * pour changer la Date_naissancen de personnel.
         ...
         /**
          * la methode Num_telephone
          * pour ajouter un numero.
